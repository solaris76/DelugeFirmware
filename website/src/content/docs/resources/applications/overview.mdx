...
A web-based synth preset editor for the Synthstrom Deluge, featuring graphical controls, full parameter editing, configurable randomisation, optional direct SYSEX file browser and transfer and direct MIDI CC control where supported.
...
<LinkPreviewCard href="https://solaris76.github.io/Deluge-Synth-Editor/" />
