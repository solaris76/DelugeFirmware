...
PLACE_SDRAM_DATA Language seven_segment{
    "Seven Segment",
    {
        ...
        {STRING_FOR_MACHINE_DETUNE, "DTUN"},
        {STRING_FOR_MACHINE_MIX, "MIX"},
        {STRING_FOR_MACHINE_SWEEP, "SWEP"},
        {STRING_FOR_MACHINE_FOLD, "FOLD"},
        {STRING_FOR_MACHINE_TRANSIENT, "TRAN"},
        {STRING_FOR_MACHINE_ROLE, "ROLE"},
        {STRING_FOR_MACHINE_COLOR, "COLR"},
        {STRING_FOR_MACHINE_CLICK, "CLIK"},
        {STRING_FOR_MACHINE_DRIVE, "DRIV"},
        {STRING_FOR_MACHINE_PHASE_DIST, "PDST"},
        {STRING_FOR_MACHINE_OSC_MOD, "OMOD"},
        ...
        {STRING_FOR_COMMUNITY_FEATURE_GENERATOR_CC_OUTPUT, "GCCO"},
