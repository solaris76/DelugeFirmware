...
PLACE_SDRAM_DATA Language english{
    "English",
    {
        ...
        {STRING_FOR_MACHINE_DETUNE, "Detune"},
        {STRING_FOR_MACHINE_MIX, "Mix"},
        {STRING_FOR_MACHINE_SWEEP, "Sweep"},
        {STRING_FOR_MACHINE_FOLD, "Wavefold"},
        {STRING_FOR_MACHINE_TRANSIENT, "Transient"},
        {STRING_FOR_MACHINE_ROLE, "Role"},
        {STRING_FOR_MACHINE_COLOR, "Color"},
        {STRING_FOR_MACHINE_CLICK, "Click"},
        {STRING_FOR_MACHINE_DRIVE, "Drive"},
        {STRING_FOR_MACHINE_PHASE_DIST, "Phase Dist"},
        {STRING_FOR_MACHINE_OSC_MOD, "Osc Mod"},
        {STRING_FOR_MACHINE_HOLD, "Hold"},
